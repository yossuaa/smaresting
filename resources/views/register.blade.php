...
<head>
    ...
    <title>Register - Smaresting</title>
...
<div class="relative z-10 w-[86%] max-w-[360px] lg:w-full lg:max-w-[1200px] bg-slate-900/80 border border-slate-700 rounded-[32px] lg:rounded-[40px] overflow-hidden grid grid-cols-1 lg:grid-cols-2 shadow-2xl shadow-emerald-500/10">
    <div class="hidden lg:flex relative overflow-hidden bg-slate-950 p-16 flex-col justify-center border-r border-slate-700">
        ...
        <div class="relative z-10">
            ...
            <h1 class="text-[68px] font-bold leading-none tracking-tight">
                Buat Akun
            </h1>
            <p class="text-[26px] text-slate-400 mt-6 leading-relaxed">
                Akun yang dibuat akan tersimpan ke tabel users dan digunakan untuk login dashboard.
            </p>
            <div class="mt-12 space-y-5">
                <div class="bg-white/5 border border-white/10 rounded-2xl p-5">
                    <h3 class="text-[24px] font-semibold text-white">User Authentication</h3>
                    <p class="text-slate-400 text-[18px] mt-2">Login hanya bisa memakai akun yang terdaftar.</p>
                </div>
                <div class="bg-white/5 border border-white/10 rounded-2xl p-5">
                    <h3 class="text-[24px] font-semibold text-white">Secure Password</h3>
                    <p class="text-slate-400 text-[18px] mt-2">Password disimpan menggunakan hash Laravel.</p>
                </div>
            </div>
        </div>
    </div>
    <div class="p-7 lg:p-16 flex flex-col justify-center bg-slate-900/80">
        <div class="mb-8">
            <div class="inline-flex items-center gap-2 bg-emerald-500/10 border border-emerald-500/30 text-emerald-300 px-4 py-2 rounded-full text-[13px] lg:text-[16px] font-semibold mb-5">
                ...
                Smart Lighting Register
            </div>
            <h1 class="text-[36px] lg:text-[54px] font-bold tracking-tight text-white">
                Register
            </h1>
            <p class="text-slate-400 text-[15px] lg:text-[22px] mt-3 leading-relaxed">
        ...
        <form method="POST" action="/register">
            @csrf
            <div class="mb-5">
                <label class="block text-[15px] lg:text-[19px] text-slate-300 mb-2">
                    Username
                </label>
                <input
                    type="text"
                    ...
                    class="w-full h-[52px] lg:h-[64px] px-5 lg:px-6 rounded-2xl border border-slate-700 bg-slate-950/70 text-white placeholder:text-slate-500 text-[15px] lg:text-[19px] outline-none focus:border-emerald-500 focus:ring-2 focus:ring-emerald-500/20 transition"
                >
                @error('username')
                    <p class="text-red-300 text-[13px] lg:text-[14px] mt-2">{{ $message }}</p>
                @enderror
            </div>
            <div class="mb-5">
                <label class="block text-[15px] lg:text-[19px] text-slate-300 mb-2">
            ...
            <button
                type="submit"
                class="w-full h-[54px] lg:h-[70px] rounded-2xl bg-emerald-500 text-white text-[18px] lg:text-[22px] font-semibold hover:bg-emerald-600 transition shadow-lg shadow-emerald-500/20">
                Buat Akun
            </button>
            <div class="mt-6 text-center">
                <p class="text-slate-400 text-[14px] lg:text-[19px]">
                    Sudah punya akun?
                    <a href="/login" class="text-emerald-400 font-semibold hover:underline">
                        Login di sini
                    </a>
                </p>
            </div>
